...
<section className="h-[93.7vh] md:h-[118.1vh] xl:h-[92.4vh]" style={{ position: "relative", backgroundColor: "#dedede" }}>
	<img src="https://czat.ai/img/avatars/full-og/kotek.jpg" alt="" className="w-[80.63347868217055%] md:w-[60.295985772357724%] xl:w-[37.552083333333336%] h-[13.402271518413066%] md:h-[40.7639785393557%] xl:h-[36.279873855389646%] left-[7.906976744186048%] md:left-[8.028455284552873%] xl:left-[3.697916666666668%] top-[80.25506648424889%] md:top-[10.062947417174282%] xl:top-[19.930665010592822%] absolute" />
<div className="w-[85.79941860465117%] md:w-[42.27134146341463%] xl:w-[38.125%] h-[32.72794802657769%] md:h-[33.742490806087545%] xl:h-[50.73027090694936%] left-[5.953246124031039%] md:left-[8.619156504065119%] xl:left-[51.30208333333336%] top-[40.353110648723856%] md:top-[58.756956626747%] xl:top-[22.002355712603073%] absolute">
	  <iframe
...
<section className="h-[93.3vh] md:h-[50vh]" style={{ position: "relative", backgroundImage: "url(https://tropimyprzygody.pl/wp-content/uploads/2023/08/inuici-%E2%80%93-7-najciekawszych-faktow-na-temat-eskimosow-1080x700.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}>
	<div className="w-[42.86458333333333%] h-[74.13043478260869%] left-[4.999999999999997%] md:left-[52.13541666666676%] xl:left-[4.999999999999997%] top-[10.869565217391303%] md:top-[9.34782608695651%] xl:top-[10.869565217391303%]" style={{ position: "absolute", backgroundColor: "#f0f0f0", backgroundImage: "url(https://images.immediate.co.uk/production/volatile/sites/63/2024/08/ciekawostki-o-grenlandii-tego-mogliscie-nie-wiedziec-o-najwiekszej-wyspie-swiata1-6095377.jpg?quality=90&resize=980,654)", backgroundSize: "cover", backgroundPosition: "center" }}>
